...
public class Player2DAction<C> : Player2DActionBase where C : Controller2DAction
{
    ...
    public override event Action<DamageHitBox2D> OnDamage;
    ...
    private void DamageOn(DamageHitBox2D container)
    {
        if (isInvictible)
            return;
...
{
    public abstract event Action<DamageHitBox2D> OnDamage;

...
public class GrappableObjectMediator
{
    ...
    /// </summary>
    public void Subscribe<T>(Action<T, BonusActionContext> handler) where T : GrappableObjectBehaviourAction
    {
        var type = typeof(T);
    ...
    /// </summary>
    public void Unsubscribe<T>(Action<T, BonusActionContext> handler) where T : GrappableObjectBehaviourAction
    {
        var type = typeof(T);
    ...
    {
        Invoke(grapObject.Behaviour, grapObject.GetContext());
    }

    public void Invoke(GrappableObjectBehaviour obj, BonusActionContext context)
    {
        foreach (var behaviourAction in obj.behaviourActions)
        {
            Invoke(behaviourAction, context);
        }
    }
    ...
    /// </summary>
    public void Invoke(GrappableObjectBehaviourAction obj, BonusActionContext context)
    {
